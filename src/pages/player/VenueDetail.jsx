  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: "#FAFAFA" }}>
      ...
      <div className="relative">
        <PhotoGallery photos={venue.photos || []} alt={venue.name} className="w-full h-60" />
        <button onClick={() => navigate(-1)} className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm p-2.5 rounded-full shadow-lg active:scale-95 transition-transform z-20">
      ...
      <div className="px-4 py-5">
        ...
        <div className="flex items-start justify-between gap-2 mb-3">
          <div className="min-w-0 flex-1">
            ...
            <div className="flex items-center gap-3 mt-1.5">
              <RatingStars rating={venue.rating || 0} reviewCount={venue.review_count || 0} size={14} />
            </div>
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {venue.payment_mode && (
            <span className="inline-flex items-center justify-center text-center bg-brand-sky text-brand-brown px-3 py-1.5 rounded-full text-sm font-semibold leading-none">
