...
export const gradientBannerExploreBold = {
  background: "radial-gradient(ellipse at -8% 110%, #EA672D 0%, #EA672Dee 14%, transparent 48%), radial-gradient(ellipse at 110% -10%, #00452A 0%, #00452Acc 14%, transparent 46%), radial-gradient(ellipse at 50% 50%, #D2E8FFdd 0%, #D2E8FF88 20%, transparent 42%), #F2EFE8",
  borderRadius: "1.5rem",
  boxShadow: "0 24px 64px -16px rgba(234,103,45,0.18), 0 8px 24px -8px rgba(0,0,0,0.08)",
};
